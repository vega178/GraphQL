...
describe('#isFunction', () => {
  it('should be true if a variable is function', () => {
    const test = () => 'bar'
...
describe('#isPassword', () => {
  it('should be true if a value is valid password', () => {
    expect(isPassword('25888721')).toBe(true)
  })

  it('should be false if a value is valid password', () => {
    expect(isNumber('258811')).toBe(false)
  })
})
...
describe('#isUndefined', () => {
  it('should return true if a variable is undifined', () => {
    let test
    expect(isUndefined(test)).toBe(true)
  })

  it('should be false if a variable is not undifined', () => {
    const test = 'foo'
